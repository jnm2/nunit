// https://raw.githubusercontent.com/dotnet/coreclr/v2.0.6/src/mscorlib/src/System/Threading/CancellationTokenSource.cs
#if NET20 || NET35
...
namespace System.Threading
{
    ...
    public class CancellationTokenSource : IDisposable
    {
            ...
            Action<object> callback, object stateForCallback, SynchronizationContext targetSyncContext, ExecutionContext executionContext)
        {
            ...
            if (!IsCancellationRequested)
            {
                ...
                var callbacks = (SparselyPopulatedArray<CancellationCallbackInfo>)Thread.VolatileRead(ref ((object[])registeredCallbacksLists)[myIndex]);
                if (callbacks == null)
                {
        ...
        private void ExecuteCallbackHandlers(bool throwOnFirstException)
        {
            ...
            try
            {
                ...
                {
                    SparselyPopulatedArray<CancellationCallbackInfo> list = (SparselyPopulatedArray<CancellationCallbackInfo>)Thread.VolatileRead(ref ((object[])callbackLists)[index]);
                    if (list != null)
                    {
    ...
    internal class SparselyPopulatedArrayFragment<T> where T : class
    {
        ...
        {
            get { return (T)Thread.VolatileRead(ref ((object[])m_elements)[index]); }
        }
